...
const Login = ({ isUserAuthenticated }) => {
    ...
    const imageURL = 'https://revenuearchitects.com/wp-content/uploads/2017/02/Blog_pic.png';
                ...
                <Image src={imageURL} alt="blog" />
                {
                    account === 'login' ?
                        <Wrapper>
                            ...
                            <SignupButton onClick={() => toggleSignup()} style={{ marginBottom: 50 }}>Sign up</SignupButton>
                        </Wrapper> :
                        <Wrapper>
                            ...
                            <Text style={{ textAlign: 'center' }}>OR</Text>
                            <LoginButton variant="contained" onClick={() => toggleSignup()}>Have an account?</LoginButton>
                        </Wrapper>
                }
            </Box>
        </Component>
